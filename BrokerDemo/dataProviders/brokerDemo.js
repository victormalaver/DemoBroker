...
(function() {
    var provider = app.data.brokerDemo = new Everlive({
            offlineStorage: true,
            appId: 'zwewsuhwcckwkw32',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'brokerDemo_access_token',
...
// START_CUSTOM_CODE_brokerDemo
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_brokerDemo